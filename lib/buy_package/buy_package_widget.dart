...
import 'buy_package_model.dart';
export 'buy_package_model.dart';

class BuyPackageWidget extends StatefulWidget {
  const BuyPackageWidget({Key? key}) : super(key: key);

  @override
  _BuyPackageWidgetState createState() => _BuyPackageWidgetState();
}

class _BuyPackageWidgetState extends State<BuyPackageWidget>
    with TickerProviderStateMixin {
  late BuyPackageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyPackageModel());
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 8.0, 0.0),
                                                  child: AutoSizeText(
                                                    'USD ${listViewPackagesRecord.price?.toString()}'
                                                        .maybeHandleOverflow(
                                                      maxChars: 70,
                                                      replacement: '…',
                                                    ),
