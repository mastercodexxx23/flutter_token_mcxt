    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'WalletBalance':
          ...
          break;
        case 'mcxtaddress':
          result.mcxtaddress = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'city':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _mcxtaddress;
  String? get mcxtaddress => _$this._mcxtaddress;
  set mcxtaddress(String? mcxtaddress) => _$this._mcxtaddress = mcxtaddress;
